...
- Here are [instructions for forking and making a pull request](https://docs.github.com/en/get-started/exploring-projects-on-github/contributing-to-a-project)
- The docs folder contains the .md files for the different tabs. You can just edit from the browser. There is no need to install anything.
Thank you and if you have any questions about the RIPS FAQ site, feel free to [email us](mailto:uclarips2023photos@gmail.com).
